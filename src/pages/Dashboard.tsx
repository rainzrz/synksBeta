      ...
      <main className="container mx-auto py-8 px-4">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400">Gerencie seus links e monitore o status de seus sites</p>
          </div>
            ...
            <DialogContent className="bg-saas-black-light border-saas-gray/20">
              <DialogHeader>
                ...
                <DialogDescription className="text-gray-400">
                  Crie um grupo para organizar seus links por empresa ou projeto.
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                <Button variant="outline" onClick={() => setIsCompanyDialogOpen(false)} className="border-saas-gray/20 text-gray-300">
                  Cancelar
                </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="bg-saas-black-light border-saas-gray/20">
            <CardHeader className="pb-2">
              <CardTitle className="text-gray-300 text-sm font-medium">Total de Empresas</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-saas-black-light border-saas-gray/20">
            <CardHeader className="pb-2">
              <CardTitle className="text-gray-300 text-sm font-medium">Total de Links</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-saas-black-light border-saas-gray/20">
            <CardHeader className="pb-2">
              <CardTitle className="text-gray-300 text-sm font-medium">Links Online</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-500">
                {links.filter(l => l.status === 'online').length}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-saas-black-light border-saas-gray/20">
            <CardHeader className="pb-2">
              <CardTitle className="text-gray-300 text-sm font-medium">Links com Problemas</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-red-500">
                {links.filter(l => l.status === 'offline' || l.status === 'error').length}
              </div>
            </CardContent>
          </Card>
        </div>
            ...
            <Card className="bg-saas-black-light border-saas-gray/20">
              <CardContent className="pt-6">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Nenhuma empresa criada</h3>
                  <p className="text-gray-400 mb-4">Comece criando uma empresa para organizar seus links</p>
                  <Button 
                      ...
                      <Dialog open={isLinkDialogOpen} onOpenChange={setIsLinkDialogOpen}>
                        ...
                        <DialogContent className="bg-saas-black-light border-saas-gray/20">
                          <DialogHeader>
                            ...
                            <DialogDescription className="text-gray-400">
                              Adicione um novo link para monitoramento em {company.name}.
                            </DialogDescription>
                          </DialogHeader>
                          <div className="grid gap-4 py-4">
                            <div className="grid gap-2">
                          ...
                          <DialogFooter>
                            <Button variant="outline" onClick={() => setIsLinkDialogOpen(false)} className="border-saas-gray/20 text-gray-300">
                              Cancelar
                            </Button>
                            <Button onClick={createLink} className="bg-saas-red hover:bg-saas-red-dark text-white">
                              Adicionar Link
                            </Button>
                          </DialogFooter>
                        </DialogContent>
